...
ggplot() +
  ...
  scale_color_manual(values = c("E[Y|do(X=x)]" = "black", "naive"="orange", "RR"="blue", "TSR"=middle_green), name = NULL) +
...
ggplot() +
  ...
  geom_boxplot(aes(x = X, y = -27), width = 5, fill = "grey", color = "black", alpha = 0.7) +
  geom_boxplot(aes(x = X_S, y = -20), width = 5, fill = "grey", color = "black", alpha = 0.7) +
  scale_color_manual(values = c("E[Y|do(X=x)]" = "black", "naive"="orange", "RR (ridge)"="blue", "TSR (ridge)"=middle_green), name = NULL) +
